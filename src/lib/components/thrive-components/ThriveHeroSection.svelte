...
<div class={` flex flex-col items-center justify-center p-5`}>
    ...
    shadow-xl flex flex-col items-center justify-center gap-10   py-10`}>
        <div class="flex flex-col items-center gap-5 text-center p-5 ">
            <h1 class="text-4xl md:text-5xl  font-extrabold md:px-5">{@html title}</h1>
            <h3>{subTitle}</h3>
            {#if description}
        ...
        <div>
            ...
            ${btnCss? btnCss : " bg-gradient-to-tr from-indigo-400 to-sky-500 hover:from-sky-500 hover:to-indigo-500 "}
    ...
    <section class="w-full md:w-[90%] lg:w-[70%] rounded-xl overflow-hidden my-5 h-auto">
        <iframe class="w-full" width="560" height="515" src="https://www.youtube.com/embed/gztJj-Y96DY?si=5QW4h9qPYZW1Pmx2&autoplay=1&rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </section>
</div>