<script>
    ...
    const frontend=[
            //ThriveHeroSection
            {
                ...
                title:"About Legiitpro",
                css: "bg-gradient-to-tr from-sky-200 to-green-500",
                btnCss: " bg-gradient-to-tr from-indigo-400 to-sky-500 hover:from-sky-500 hover:to-indigo-500 ",
                subTitle: "Your Trusted Business Collaborators",
...
<ThriveHeroSection section={frontend[0]}/>
<ThriveTopicIntro section={frontend[2]}/>
<ThriveBrandReviews section={frontend[1]}/>
<div>About Page</div>